...
namespace paypart_payment_gateway
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<Settings>(options =>
            {
                ...
                options.authToken = Configuration.GetSection("AppSettings:authToken").Value;
                options.payStackBaseURL = Configuration.GetSection("AppSettings:payStackBaseURL").Value;
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "paypart payment gateway", Version = "v1" });
            });
            //services.AddTransient<ILocationMongoRepository, LocationMongoRepository>();
            //services.AddTransient<ILocationSqlServerRepository, LocationSqlServerRepository>();
            ...
            //SQL Server
            //services.AddDbContext<LocationSqlServerContext>(options => options.UseSqlServer(
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "paypart payment gateway v1");
            });
